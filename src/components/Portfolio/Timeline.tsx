...
const Timeline = () => {
  const timelineData = [
    {
      ...
      title: "B.Com Honors",
      description:
        "Completed Bachelor of Commerce with honors, building strong foundational knowledge in business and commerce.",
      icon: BookOpen,
    ...
    },
    {
      ...
      description:
        "Pursued three years of intensive legal education, developing expertise in various branches of law.",
      icon: Award,
    ...
    },
    {
      ...
      description:
        "Advanced training and preparation at a premier coaching institute, enhancing professional capabilities.",
      icon: Briefcase,
  ...
  visible: {
    ...
    transition: {
      duration: 0.6,
      ease: easeOut, // ✅ PERFECT FOR ALL VERSIONS
    },
  },
};
              ...
              {timelineData.map((item, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`flex gap-4 md:gap-0 items-start md:items-center ${
                    ...
                    >
                      <motion.div
                        ...
                        className={`bg-white rounded-lg shadow-lg p-6 border-l-4 ${
                          isEven ? "md:border-l-0 md:border-r-4" : ""
                        } border-purple-600`}
                      >
                        <div className="flex items-center gap-3 mb-3">
                          <div
                            className={`bg-gradient-to-br ${item.color} p-3 rounded-full flex-shrink-0`}
                          >
